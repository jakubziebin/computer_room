...
class DFRobot_SCD4X(object):
  ...
  async def begin(self):
    ...
    '''
    await self.enable_period_measure(SCD4X_STOP_PERIODIC_MEASURE)
    ret = True
  ...
  async def set_sleep_mode(self, mode):
    '''!
  ...
  async def measure_single_shot(self, mode):
    '''!
  ...
  async def enable_period_measure(self, mode):
    '''!
  ...
  async def perform_forced_recalibration(self, CO2ppm):
    '''!
